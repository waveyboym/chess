...
class queen : public piece{
    ...
    public:
        ...
        /**
        * @brief the queen constructor intialises the various member variables
        * 
        ...
        * 
        */
        queen(int newX, int newY, char teamcolour, char piecetype);
        ...
        */
        ...
        //static function
        /**
        * @brief checks if a queen can check the king on the board if the king moved to passed in x and y co-ords
        * 
        ...
        * @return bool
        */
        static bool can_queen_check_king(int currentX, int currentY, char teamcolor, piece*** currentboard);
};
