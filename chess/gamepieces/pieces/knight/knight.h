...
class knight : public piece{
    ...
    public:
        ...
        /**
        * @brief the knight constructor intialises the various member variables
        * 
        ...
        * 
        */
        knight(int newX, int newY, char teamcolour, char piecetype);
        ...
        */
        ...
        //static function
        /**
        * @brief checks if a knight can check the king on the board if the king moved to passed in x and y co-ords
        * 
        ...
        * @return bool
        */
        static bool can_knight_check_king(int currentX, int currentY, char teamcolor, piece*** currentboard);
};
