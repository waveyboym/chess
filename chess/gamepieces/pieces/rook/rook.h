...
class rook : public piece{
    ...
    public:
        ...
        /**
        * @brief the rook constructor intialises the various member variables
        * 
        ...
        * 
        */
        rook(int newX, int newY, char teamcolour, char piecetype);
        ...
        */
        ...
        //static function
        /**
        * @brief checks if a rook can check the king on the board if the king moved to passed in x and y co-ords
        * 
        ...
        * @return bool
        */
        static bool can_rook_check_king(int currentX, int currentY, char teamcolor, piece*** currentboard);
};
